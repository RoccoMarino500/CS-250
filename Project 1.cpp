...
void seatSelection()
{
	...
	try
	{
		...
		{
			throw runtime_error(" does not exist"); //Exception
		}
	}
	...
	try
	{
		...
		{
			throw runtime_error(" has an invalid seat number please ");
		}
		else if (selection[1] == '1') //Getting the seat number for the row
		{
			...
			{
				throw runtime_error(" is taken please "); //Exception
			}
		}
		else if (selection[1] == '2')
		{
			...
			{
				throw runtime_error(" is taken please ");
			}
		}
